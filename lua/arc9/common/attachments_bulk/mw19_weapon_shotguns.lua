...
ATT.Icon = Material("entities/attachs/sh/model680/cod2019_sh_model680_barrel_sawn.png", "mips smooth")
ATT.AutoStats = true
...
if !warzonestats then -- Regular Stats
	...
	ATT.AimDownSightsTimeAdd = -0.030
end
