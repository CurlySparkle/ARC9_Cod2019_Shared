...
ATT.ShellModel = "models/weapons/cod2019/shared/shell_asval.mdl"
ATT.ShellScale = 1
...
if !warzonestats then -- Regular Stats
	ATT.AimDownSightsTimeMult = 0.87
	ATT.DeployTimeMult = 0.92
	ATT.RecoilUpMult = 1.11
	ATT.RecoilSideMult = 1.11
else -- Warzone Stats
