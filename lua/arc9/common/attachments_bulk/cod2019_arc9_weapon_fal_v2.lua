...
ATT.Icon = Material("entities/attachs/cod2019_ar_fal_reciever_v2.png", "mips smooth")
ATT.AutoStats = true
ATT.Free = false
ATT.SortOrder = 1
...
ATT.CompactName = "Dominator"
ATT.Description = [[Smooth like a criminal]]
ATT.Icon = Material("entities/attachs/cod2019_ar_fal_stock_v2.png", "mips smooth")
ATT.AutoStats = true
ATT.Free = false
ATT.SortOrder = 1
