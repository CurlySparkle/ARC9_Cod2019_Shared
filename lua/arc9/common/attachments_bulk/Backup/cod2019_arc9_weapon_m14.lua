...
-- ATT.Model = "models/weapons/cod2019/attachs/weapons/m14/attachment_vm_sn_mike14_strap.mdl"
-- ATT.BoneMerge = true

-- ATT.MenuCategory = "ARC9 - MW2019 Attachments"
-- ATT.Category = {"cod2019_m14_extra"}
-- ATT.ActivateElements = {"strap"}

-- ARC9.LoadAttachment(ATT, "cod2019_m14_strap")
---------------------------------------------------------------------------------------