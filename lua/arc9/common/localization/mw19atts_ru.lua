...
L["cod2019_m4a1_mag_socom.printname"] = "Магазины на 10 патронов .458 SOCOM"
L["cod2019_m4a1_mag_socom.compactname"] = "10П SOCOM"
L["cod2019_m4a1_mag_socom.description"] = "Конверсия под крупнокалиберные боеприпасы <color=255,255,100>.458 SOCOM</color>, обладающие намного большим убойным действием. также замедляет цикл работы автоматики, чтобы помочь стрелку справиться с отдачей."
