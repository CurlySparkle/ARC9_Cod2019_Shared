...
//////////////////// FAL
/////////////// Barrels
L["cod2019_fal_barrel_01.printname"] = "Ультралегкий 18,0 дюйма"
L["cod2019_fal_barrel_01.description"] = "Особый, покрытый лунками расширенный канал ствола уменьшает вес оружия, тем самым повышая его эргономичность, но снижает начальную скорость пули."
